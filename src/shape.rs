...
impl Shape {
	/// Internal constructor: wrap an inner pointer with an empty colormap.
	pub(crate) fn from_inner(inner: cxx::UniquePtr<ffi::TopoDS_Shape>) -> Shape {
		Shape {
			inner,
			#[cfg(feature = "color")]
